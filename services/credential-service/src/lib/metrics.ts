/**
 * Zero-dependency Prometheus text-format metrics for credential-service.
...
export const httpRequests = defineCounter(
  'credential_http_requests_total',
  'Total HTTP requests handled by credential-service.',
);

export const credentialOps = defineCounter(
  'credential_ops_total',
  'Total credential operations (list, get, upsert, delete).',
);

export const oauthFlows = defineCounter(
  'credential_oauth_flows_total',
  'Total OAuth flows initiated or completed.',
);

// ── Gauges ────────────────────────────────────────────────────────────────────

export const vaultEntries = defineGauge(
  'credential_vault_entries',
  'Approximate number of credentials stored in the vault.',
);
