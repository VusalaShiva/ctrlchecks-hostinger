/**
 * Zero-dependency Prometheus text-format metrics for notification-service.
...
export const notificationDelivery = defineCounter(
  'notification_delivery_total',
  'Total notification deliveries attempted by channel and status.',
);

export const webhookDelivery = defineCounter(
  'notification_webhook_delivery_total',
  'Total webhook deliveries by status.',
);

// ── Gauges ────────────────────────────────────────────────────────────────────

export const pendingWebhooks = defineGauge(
  'notification_pending_webhooks',
  'Number of webhook deliveries currently pending or in-flight.',
);
