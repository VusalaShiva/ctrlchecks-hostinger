/**
 * Zero-dependency Prometheus text-format metrics for trigger-service.
...
export const httpRequests = defineCounter(
  'trigger_http_requests_total',
  'Total HTTP requests handled by trigger-service.',
);

export const triggerDispatched = defineCounter(
  'trigger_dispatch_total',
  'Total triggers dispatched by type and status.',
);

export const triggerEnqueued = defineCounter(
  'trigger_enqueued_total',
  'Total execution jobs enqueued by trigger type.',
);

// ── Gauges ────────────────────────────────────────────────────────────────────

export const activeDispatches = defineGauge(
  'trigger_active_dispatches',
  'Number of trigger dispatches currently in-flight.',
);
